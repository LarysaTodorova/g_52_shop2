...
//    @Pointcut("execution(* de.aittr.g_52_shop2.service.ProductServiceImpl.save(de.aittr.g_52_shop2.domain.dto.ProductDto))")
...
//        logger.info("Method save of the class ProductServiceImpl was called with argument {}", args[0]);
//    }
//
//    @After("saveProduct()")
...
//    }
//
//    @Pointcut("execution(* de.aittr.g_52_shop2.service.ProductServiceImpl.getById(Long))")
